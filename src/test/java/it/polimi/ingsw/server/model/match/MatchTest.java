...
import it.polimi.ingsw.server.model.board.PlayerSlot;
import it.polimi.ingsw.server.model.cards.Card;
import it.polimi.ingsw.server.model.cards.buildingCards.*;
...
import it.polimi.ingsw.server.model.cards.eventCards.Sustenance;
import it.polimi.ingsw.server.model.decks.Deck;
import it.polimi.ingsw.server.model.enums.*;
...
class MatchTest {
    ...
    private static void setMainDeckCards(Match match, List<Card> eraICards, List<Card> eraIICards, List<Card> eraIIICards) {
        try {
            Field eraIField = Deck.class.getDeclaredField("era_I_cards");
            Field eraIIField = Deck.class.getDeclaredField("era_II_cards");
            Field eraIIIField = Deck.class.getDeclaredField("era_III_cards");
